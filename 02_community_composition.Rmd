...
```{r figure_bar_phylum, comment="", message=FALSE, warning=FALSE, fig.height=8, fig.width=16, fig.fullwidth=TRUE}
...
```{r figure_scat_family, comment="", message=FALSE, warning=FALSE, fig.height=8, fig.width=12, fig.fullwidth=TRUE}
