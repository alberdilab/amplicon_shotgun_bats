# Metagenomics
## Load raw data
```{r loaddata, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
## Read counts
```{r melt, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
## Melt dataframe
...
## Genome counts
```{r coverage, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
## Sample metadata
```{r loadmetadata, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
## Genome metadata
```{r loadgenomedata, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
## Genome tree
```{r loadtree, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
## Preprocessing info
```{r prepro, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
## Genome annotations
```{r annotation, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
genome_annotations <- read_tsv("resources/metagenomics/all_annotations.tsv.xz")
```

## Genome functions distillation
```{r distillation, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
## Phyloseq object
```{r nozero_phylo, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r savedata, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
# Amplicon
## Load data
```{r ampli, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r amplidata, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
#Phyloseq object
...
# Remove contaminants
```{r decotam, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r phylodec, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
## Basic filtering
```{r basicfilt, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
read_counts_final <- data.frame(physeq.final@otu_table) 
count_filtdepth <- depth_filt(read_counts_final,1000)#decide the level
...
```{r chlormito, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
## Save
```{r save16S, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
saveRDS(physeq.final.filt,"resources/amplicon/physeq_final_nocopyfilter.RData")
```

# Merging amplicon and shotgun data

```{r load16Sdata, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r cleandata, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
```
```{r filterdata, comment="", echo=FALSE, message=FALSE, warning=FALSE}
asv_16S_filt <- asv_16S_filt[rowSums(asv_16S_filt[, -1] > 0) != 0, ] %>% 
  rownames_to_column(., "asv")
```

```{r sampledata, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
```
```{r comparabledata, comment="", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r metagenomicdata, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r 16Sdata, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
```
```{r save_ampli, comment="", echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
save(sample_metadata, 
     genome_metadata,
     genome_counts_filt,
