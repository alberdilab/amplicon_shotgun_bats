...
```{r microbial_fraction, comment="", message=FALSE, warning=FALSE, eval=FALSE}
...
## Amplicon
### Load data
```{r load_ampli, comment="", message=FALSE, warning=FALSE, eval=FALSE}
...
## Merging amplicon and metagenomic data
...
```{r save_16S, comment="", message=FALSE, warning=FALSE, eval=FALSE}
# save(sample_metadata_16S, 
#      genome_metadata_16S,
#      file = "resources/amplicon/data_withoutcopy.Rdata")
```

### Filtering the metagenomic data to match amplicon data
```{r comparabledata, comment="", message=FALSE, warning=FALSE, eval=FALSE}
...
```{r metagenomicdata_save, eval=FALSE, message=FALSE, warning=FALSE, comment=""}
save(sample_metadata, 
     genome_metadata, 
     read_counts, 
     genome_counts,
...
### Matching the 16S data to metagenomic data
...
```
```{r save_ampli_nocopy, comment="", message=FALSE, warning=FALSE, eval=FALSE}
save(sample_metadata, 
     genome_metadata,
     genome_counts_filt,
...
### Standard data filtering criteria
```{r div_load_data_standard, comment="", message=FALSE, warning=FALSE}
load("resources/amplicon/data_nocopyfilt.Rdata")
```

```{r filter_standard, comment="", message=FALSE, warning=FALSE}
genome_metadata <- genome_metadata %>%
  filter(!is.na(phylum))
...
```{r load_data_amplicon_no_filtered, comment="", message=FALSE, warning=FALSE, eval=FALSE}
load("resources/amplicon/data_nocopyfilt.Rdata")
```
