...
```{r load_data_func_met,comment="", message=FALSE, warning=FALSE}
...
### Differences in functional traits considering the three species
...
```{r load_data_func_sta,comment="", message=FALSE, warning=FALSE}
load("resources/amplicon/data_standard_filt.Rdata")
```

### Prepare for PicrusT

```{r prepare_picrust,comment="", message=FALSE, warning=FALSE, eval=FALSE}
...
```{sh run_picrust,comment="", message=FALSE, warning=FALSE, eval=FALSE}
...
```{r load_functions,comment="", message=FALSE, warning=FALSE, eval=FALSE}
...
```{r distillr_functions,comment="", message=FALSE, warning=FALSE, eval=FALSE}
...
```{r distillr_functions_merge, comment="", message=FALSE, warning=FALSE}
...
```{r distillr_functions_community_standard, comment="", message=FALSE, warning=FALSE}
amplicon_func_community_standard %>%
    as.data.frame() %>%
...
```{r distillr_functions_community_sel,comment="", message=FALSE, warning=FALSE}
