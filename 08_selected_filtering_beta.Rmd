...
**Number of MAGs**
```{r mag_number_sel_beta, comment="", message=FALSE, warning=FALSE}
...
```{r arch_phyla_meta_sel_beta, comment="", message=FALSE, warning=FALSE}
genome_metadata_amplicon %>% 
...
```{r bact_meta_sel_beta, comment="", message=FALSE, warning=FALSE}
genome_metadata_amplicon %>% 
