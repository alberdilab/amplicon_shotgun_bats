...
```
```{r}
Model_richness_random <- glmer.nb(richness ~ Species*method+(1|sample), data = alpha_div_family_data_filt)
...
```
```{r}
Model_richness_phylum_random <- glmer.nb(richness ~ Species*method+(1|sample), data = alpha_div_phylum_data_filt)
